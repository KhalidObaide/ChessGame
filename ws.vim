...
nnoremap ,; :w !python3
nnoremap ,b :!g++ %:p -o CPP_TEMPERARY_OUTPUT_FILE && ./CPP_TEMPERARY_OUTPUT_FILE && rm ./CPP_TEMPERARY_OUTPUT_FILE
...
silent only
silent tabonly
cd ~/Documents/js_projects/chess/app
...
silent! normal! zE
let s:l = 159 - ((11 * winheight(0) + 12) / 24)
...
wincmd w
argglobal
if bufexists("helpers.js") | buffer helpers.js | else | edit helpers.js | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
